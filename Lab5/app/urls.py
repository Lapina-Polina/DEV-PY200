...
from .views import (index_view, template_view, login_view, register_view, reset_view,
                    logout_view, user_detail_view, get_text_json)

from .views import MyTemplView, TemplView, MyFormView, MyLoginView
...
urlpatterns = [
    ...
    path("get/text/", get_text_json, name="get_text"),
]